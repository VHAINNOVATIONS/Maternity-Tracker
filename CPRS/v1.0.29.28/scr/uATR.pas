...
//TFF - added initialization and finalization of slPtList - was causing an error when the dll
// was not present within fPtSel procedure TfrmPtSel.cmdOKClick(Sender: TObject);
initialization
