...
uses Hash, uCore, ShlObj, Windows, uATR;
  ...
  try
    ...
    begin
      try
        ...
        GetEnhancedNotifications(tmplst2, RPCBrokerV, IntToStr(User.DUZ));
        for cntr := 0 to tmplst2.Count - 1 do
         tmplst.Insert(0,tmplst2[cntr]);
      finally
       tmplst2.Free;
      end;
    end;
