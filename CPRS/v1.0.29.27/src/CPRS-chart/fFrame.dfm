inherited frmFrame: TfrmFrame
  ...
  object mnuFrame: TMainMenu
    ...
    object mnuTools: TMenuItem
      ...
      object mnuShowFilteredATRS: TMenuItem
        Caption = '&Show SMART Notifications Now'
        Enabled = False
        Visible = False
        OnClick = mnuShowFilteredATRSClick
      end
      object mnuAlwaysShowFilteredATRs: TMenuItem
        Caption = '&Always Show SMART Notifications'
        Enabled = False
        Visible = False
        OnClick = mnuAlwaysShowFilteredATRsClick
      end
    end
