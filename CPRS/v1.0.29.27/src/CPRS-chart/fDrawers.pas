...
uses
  ...
  VA508ImageListLabeler, uConst {//ATR};
...
type
  ...
  protected
    ...
    procedure NewRECDragOver(Sender, Source: TObject; X, Y: Integer; State: TDragState;
                             var Accept: Boolean);
//    procedure InsertText;    //ATR - TFF - moved to public
  ...
  public
    ...
    procedure InsertText; //ATR - TFF - Moved from protected
  published
...
begin
  ...
  begin
    if ((bATRAval) and (Notifications.Active) and (Notifications.FollowUp = NF_ATR)) then
    begin
    ...
    if dmodShared.TemplateOK(tvTemplates.Selected.Data) then
    begin
