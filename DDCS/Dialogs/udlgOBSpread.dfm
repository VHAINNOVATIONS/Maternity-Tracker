object dlgOBSpread: TdlgOBSpread
  ...
  object sgStandard: TJvStringGrid
    ...
    FixedCols = 0
    RowCount = 2
    Options = [goFixedVertLine, goFixedHorzLine, goVertLine, goHorzLine, goRangeSelect, goDrawFocusSelected, goColSizing, goRowMoving, goEditing, goTabs, goAlwaysShowEditor, goFixedColClick, goFixedHotTrack]
