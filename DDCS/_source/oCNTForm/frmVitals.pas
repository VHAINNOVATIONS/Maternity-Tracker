      ...
      begin
        ...
        begin
          ...
          case Row of
            ...
            6: begin                                                                     // Unknown
                 daydiff := DaysBetween(Today, IncDay(dtEDDUnknown.Date, -280));
...
begin
  ...
  if edtFinalGA.Text <> '' then
    Result.Add('     Final GA: ' + edtFinalGA.Text);
...
begin
  ...
  try
    ...
    sl.Add('EDD^' + lblEmbryo.Caption + U + DateToStr(dtUltra.Date) + U + edtWeekEmbryo.Text + 'w' +
