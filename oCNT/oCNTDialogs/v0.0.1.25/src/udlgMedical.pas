...
uses
  ...
  StdCtrls, ExtCtrls, Buttons, ComCtrls, oCNTBase, uExtndComBroker;

type
  TdlgMedical = class(ToCNTDialog)
    Panel1: TPanel;
    lbltitle: TLabel;
    Panel2: TPanel;
    bbtnOK: TBitBtn;
...
{precheck medical}
//  if ((Check4True(TabSheet1)) = True) or((Check4True(TabSheet2)) = True) then
//    begin
...
begin
 if (Sender is TCheckBox) then
  ...
  999: ToggleCB(CheckBox999,CheckBox998);
    ...
    43: begin
          ToggleCB(CheckBox43,CheckBox44);
          Edit21.Enabled := True;
          LabeledEdit2.Enabled := True;
          SpeedButton1.Enabled := True;
        end;
    44: begin
          ToggleCB(CheckBox44,CheckBox43);
          Edit21.Clear;
...
procedure TdlgMedical.BitBtn3Click(Sender: TObject);
var  {1st tab}
  I : Integer;
begin   {Negative for all}
  for I := 0 to TabSheet2.ControlCount -1 do
