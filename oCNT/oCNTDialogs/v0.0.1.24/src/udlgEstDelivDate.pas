...
begin
  ...
  if ((edtEDDOther.Text <> '') and (edtEDDOther.Text <> 'Enter Other Criteria')) then
  begin
    TmpStrList.Add('   EDD Criteria of ' + edtEDDOther.Text);
...
begin
  ...
  begin
    ...
    begin
      ...
      if StrToDate(TdlgMenstHist(TTabSheet(Parent).PageControl.Pages[I].Controls[J]).edtLMP.Text) <> dtLMP.Date then
